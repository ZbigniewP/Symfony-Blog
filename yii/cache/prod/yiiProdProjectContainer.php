 ...
 */
class yiiProdProjectContainer extends Container
{
    private $parameters;
    ...
    {
        return $this->services['cache.app'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('jG-qO51PJX', 0, (__DIR__.'/pools'));
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YXaZBwIRa0', 0, 'nf1xvYDk2IKOInSPEEcE+Z', (__DIR__.'/pools'), NULL);
    }
    ...
    {
        return $this->services['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, NULL, -1, 0, false, new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL), false);
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BbJBw02Dsz', 0, 'nf1xvYDk2IKOInSPEEcE+Z', (__DIR__.'/pools'), NULL);
    }
    ...
    {
        return $this->services['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('-fKXwxcDo6', NULL, 'nf1xvYDk2IKOInSPEEcE+Z', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'yiiProdProjectContainer',
            ...
            'router.options.matcher.cache_class' => 'yiiProdProjectContainerUrlMatcher',
            'router.options.generator.cache_class' => 'yiiProdProjectContainerUrlGenerator',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => 'kernel:loadRoutes',
            'router.cache_class_prefix' => 'yiiProdProjectContainer',
